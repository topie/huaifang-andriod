...
class HFMsgFragment : HFBaseFragment() {
    ...
    override fun onCreateViewSupport(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        list.add(HFListAdapter.HFListItem(R.mipmap.ic_facing_index_fun_live, context.getString(R.string.facing_index_fun_live)))
        list.add(HFListAdapter.HFListItem(R.mipmap.ic_facing_index_fun_announcement, context.getString(R.string.facing_index_fun_announcement)))
        list.add(HFListAdapter.HFListItem(R.mipmap.ic_facing_index_fun_yellow_book, context.getString(R.string.facing_index_fun_yellow_book)))
